            ...
            <div className="main">
                <div className="details" id="klausul1">
                    ...
                    <Card style={{ boxShadow: "0 7px 25px rgb(0 0 0 / 8%)", borderRadius: 20 }}>
                        ...
                        <br />
                        <p>
                            <b>9.1</b> Pemantauan, pengukuran, analisis dan evaluasi kinerja energi dan EnMS
