...
const Document5 = () => {
    ...
    const getDokumen = async () => {
        try {
            const response = await axios.get('/document5', {
            ...
            console.error(err);
            navigate('/klausul5', { state: { from: location }, replace: true });
        }
    }
                ...
                <div className="details" id="klausul1">
                    ...
                    <Card style={{ boxShadow: "0 7px 25px rgb(0 0 0 / 8%)", borderRadius: 20 }}>
                        ...
                        <p>
                            ...
                            <br />
                            <b>5.3</b> Organization roles, responsibilities and authorities
                            <div className="input-field input-dokumen">
                                <div className="">
                                    <FontAwesomeIcon icon={faListNumeric} className='icon' />
                                </div>
