...
const Document7 = () => {
    ...
    const getDokumen = async () => {
        try {
            const response = await axios.get('/document7', {
            ...
            console.error(err);
            navigate('/klausul7', { state: { from: location }, replace: true });
        }
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                DATA_URL,
                JSON.stringify({ name, receiptId, price1, price2, subSatu, subDua, subTiga, subEmpat, subLima }),//data.img baseFile
            ...
            <div className="main">
                <div className="details" id="klausul1">
                    ...
                    <Card style={{ boxShadow: "0 7px 25px rgb(0 0 0 / 8%)", borderRadius: 20 }}>
                        ...
                        <br />
                        <p>
                            <b>7.1</b> Actions to address risks and opportunities
                            ...
                            <br />
                            <b>7.2</b> Objectives, energy targets and planning to achieve them
                            <div className="input-field input-dokumen">
                                <div className="">
                            ...
                            <br />
                            <b>7.4</b> Energy performance indicators
                            <div className="input-field input-dokumen">
                                <div className="">
                                    <FontAwesomeIcon icon={faListNumeric} className='icon' />
                                </div>
