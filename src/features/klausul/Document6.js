...
const Document6 = () => {
    ...
    const [subLima, setSubLima] = useState("")
    const [subEnam, setSubEnam] = useState("")
    ...
    const getDokumen = async () => {
        try {
            const response = await axios.get('/document6', {
            ...
            console.error(err);
            navigate('/klausul6', { state: { from: location }, replace: true });
        }
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                DATA_URL,
                JSON.stringify({ name, receiptId, price1, price2, subSatu, subDua, subTiga, subEmpat, subLima, subEnam }),//data.img baseFile
                ...
                <div className="details" id="klausul1">
                    ...
                    <Card style={{ boxShadow: "0 7px 25px rgb(0 0 0 / 8%)", borderRadius: 20 }}>
                        ...
                        <p>
                            ...
                            <br />
                            <b>6.2</b> Objectives, energy targets and planning to achieve them
                            <div className="input-field input-dokumen">
                                <div className="">
                            ...
                            <br />
                            <b>6.4</b> Energy performance indicators
                            <div className="input-field input-dokumen">
                                <div className="">
                                    <FontAwesomeIcon icon={faListNumeric} className='icon' />
                                </div>
                            ...
                            <div className="input-field input-dokumen">
                                ...
                                <input
                                    type="text"
                                    name="subLima"
                                    placeholder="Input 6.5"
                                    className="form-control"
                                    id="subLima"
                                    onChange={(e) => setSubLima(e.target.value)}
                                    required
                                />
                            </div>
                            <br />
                            <b>6.6</b> Planning for collection of energy data
                            <div className="input-field input-dokumen">
                                <div className="">
                                    <FontAwesomeIcon icon={faListNumeric} className='icon' />
                                </div>
                                <input
                                    type="text"
                                    name="subEnam"
                                    placeholder="Input 6.6"
                                    className="form-control"
                                    id="subEnam"
                                    onChange={(e) => setSubEnam(e.target.value)}
                                    required
                                />
                            </div>
